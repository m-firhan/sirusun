        ...
        <div class="box-body" style="scroll-behavior: sc;">
            ...
            <div class="direct-chat-messages">
                ...
                <div class="direct-chat-msg">
                    ...
                    <!-- /.direct-chat-info -->
                    <img class="direct-chat-img" src="<?php echo base_url('assets/dist/img/avatar.png');?>" alt="Message User Image"><!-- /.direct-chat-img -->
            ...
            <div class="direct-chat-contacts">
                <ul class="contacts-list">
                    <li>
                        <a href="#">
                            <img class="contacts-list-img" src="<?php echo_base('/dist/img/user1-128x128.jpg');?>" alt="User Image">
